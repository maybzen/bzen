...
const SUGGEST_RULES = [
  ...
  { re: /택시|티머니|코레일|KTX|SRT|기차|항공|고속버스|공항|철도|지하철|버스|숙박|크루즈/, type: 'opex', category: '여비교통비' },
  ...
  {
    re: /김밥|식대|식당|레스토랑|급식|뷔페|족발|치킨|피자|햄버거|국밥|냉면|분식|돈까스|삼겹|갈비|초밥|중식|양식|한식|일식|카페|커피|베이커리|제과|과자|빵집|아이스크림|빙수|설빙|투마미|미분당|케이크|도넛|샌드위치|샐러드|포케|마라탕|떡볶이|순대|쌀국수|칼국수|국수|라면|짬뽕|짜장|탕수육|카레|커리|횟집|사시미|참가자미|참치|광어|연어|파스타|스테이크|고깃집|술집|호프|이자카야|브런치|도시락|후식|다과|음료|주스|케이터링|연회|리셉션|멀미|소화제/,
    type: 'opex',
    category: '복리후생비',
  },
  ...
  { re: /다이소|문구|마트|편의점|올리브영|이케아|하이마트|전자랜드|쿠팡|GS25|지에스|CU\b|씨유|세븐일레븐|이마트24|미니스톱|홈플러스|롯데마트|풍선|파티/, type: 'opex', category: '소모품비' },
